...
class StaticDataTests(TestCase):
    ...
    def test_headRequest(self):
        """
        L{Data.py.render} returns an empty response body for a I{HEAD} request.
        """
    ...
    def test_invalidMethod(self):
        """
        L{Data.py.render} raises L{UnsupportedMethod} in response to a non-I{GET},
        non-I{HEAD} request.
        """
...
class StaticFileTests(TestCase):
    ...
    def test_processors(self):
        ...
        base.child("foo.bar").setContent(
            b"from twisted.web.static import Data.py\n"
            b"resource = Data.py(b'dynamic world', 'text/plain')\n")
