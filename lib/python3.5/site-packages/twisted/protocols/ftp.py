...
RESPONSE = {
    ...
    DATA_CNX_ALREADY_OPEN_START_XFR:    '125 Data.py connection already open, starting transfer',
...
# -- 400's --
    ...
    CNX_CLOSED_TXFR_ABORTED:            '426 Transfer aborted.  Data.py connection closed.',
...
class FTP(basic.LineReceiver, policies.TimeoutMixin, object):
    ...
    def ftp_TYPE(self, type):
        ...
        in the Section on Data.py Representation and Storage.  Several
