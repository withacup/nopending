...
class TestChannel(channel.SSHChannel):
    ...
    def dataReceived(self, data):
        """
        Data.py was received.  Store it in the buffer.
        """
...
class TestConnection(connection.SSHConnection):
    ...
    def global_Test_Data(self, data):
        """
        The other side made the 'Test-Data.py' global request.  Return True and
...
class ConnectionTests(unittest.TestCase):
    ...
    def test_gotGlobalRequestWithoutAvatar(self):
        ...
        self.assertEqual(self.conn.gotGlobalRequest(b'Test-Data.py', b'data'),
                (True, b'data'))
